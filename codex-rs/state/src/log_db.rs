...
pub fn default_filter() -> Targets {
    Targets::new()
        // TRACE is useful when explicitly requested, but persisting it by
        // default turns streaming payloads into continuous SQLite churn.
        // Keep DEBUG and above for local diagnostics without entering the
        // database write path for ordinary trace events.
